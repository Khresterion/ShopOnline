...
class OrderCrudController extends AbstractCrudController
{
    ...
    {
        $updatePreparation = Action::new('updatePreparation', 'Préparation en cours')->linkToCrudAction('updatePreparation')->setIcon('fas fa-box-open');
        $updateDelivery = Action::new('updateDelivery', 'Livraison en cours')->linkToCrudAction('updateDelivery')->setIcon('fas fa-shipping-fast');
        return $actions
